...
const heapSort = arr => {
    ...
    for ( let i = Math.floor(l / 2); i >= 0; i -= 1 ) {
        maxHeap(arrCopy, i, l); // construct max heap
    }
    for ( let i = arrCopy.length - 1; i > 0; i-- ) {// One by one extract elements
